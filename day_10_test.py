...
from day_10 import parse_instruction, part_1, part_2


class TestDay10(TestCase):
    _instructions: list[int]

    def setUp(self):
        self._instructions = list(map(parse_instruction,
                                      ['addx 15', 'addx -11', 'addx 6', 'addx -3', 'addx 5', 'addx -1', 'addx -8',
                                       ...
                                       'addx 1', 'addx 5', 'noop', 'noop', 'noop', 'noop', 'noop', 'addx -36', 'noop',
                                       'addx 1', 'addx 7', 'noop', 'noop', 'noop', 'addx 2', 'addx 6', 'noop', 'noop',
                                       'noop', 'noop', 'noop', 'addx 1', 'noop', 'noop', 'addx 7', 'addx 1', 'noop',
                                       ...
                                       'addx -19', 'addx 1', 'addx 3', 'addx 26', 'addx -30', 'addx 12', 'addx -1',
    ...
    def test_part_1(self):
        self.assertEqual(part_1(self._instructions), 13_140)

    def test_part_2(self):
        self.assertEqual(part_2(self._instructions), '##  ##  ##  ##  ##  ##  ##  ##  ##  ##\n'
                                                     '###   ###   ###   ###   ###   ###   ###\n'
                                                     '####    ####    ####    ####    ####\n'
                                                     '#####     #####     #####     #####\n'
                                                     '######      ######      ######\n'
